...
### Base URL
```
https://tribe-api-client.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://tribe-api-client.preview.emergentagent.com/api/healthz
GET  https://tribe-api-client.preview.emergentagent.com/api/tribes
POST https://tribe-api-client.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://tribe-api-client.preview.emergentagent.com`
