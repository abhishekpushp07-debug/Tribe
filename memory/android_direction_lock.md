...
```
GET  https://media-app-docs.preview.emergentagent.com/api/healthz
GET  https://media-app-docs.preview.emergentagent.com/api/tribes
POST https://media-app-docs.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://media-app-docs.preview.emergentagent.com`
