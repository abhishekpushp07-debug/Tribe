...
```
GET  https://gap-closure-phase-c.preview.emergentagent.com/api/healthz
GET  https://gap-closure-phase-c.preview.emergentagent.com/api/tribes
POST https://gap-closure-phase-c.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://gap-closure-phase-c.preview.emergentagent.com`
