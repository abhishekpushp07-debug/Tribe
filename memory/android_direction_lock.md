...
### Base URL
```
https://social-alerts-4.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://social-alerts-4.preview.emergentagent.com/api/healthz
GET  https://social-alerts-4.preview.emergentagent.com/api/tribes
POST https://social-alerts-4.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://social-alerts-4.preview.emergentagent.com`
