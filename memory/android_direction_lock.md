...
```
GET  https://latency-crusher.preview.emergentagent.com/api/healthz
GET  https://latency-crusher.preview.emergentagent.com/api/tribes
POST https://latency-crusher.preview.emergentagent.com/api/auth/register
```
