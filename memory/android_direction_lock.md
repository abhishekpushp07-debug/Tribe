...
### Base URL
```
https://api-consistency-hub.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://api-consistency-hub.preview.emergentagent.com/api/healthz
GET  https://api-consistency-hub.preview.emergentagent.com/api/tribes
POST https://api-consistency-hub.preview.emergentagent.com/api/auth/register
```
