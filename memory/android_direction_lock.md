...
```
GET  https://tribal-architecture.preview.emergentagent.com/api/healthz
GET  https://tribal-architecture.preview.emergentagent.com/api/tribes
POST https://tribal-architecture.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://tribal-architecture.preview.emergentagent.com`
