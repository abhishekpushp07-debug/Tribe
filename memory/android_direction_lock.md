...
```
GET  https://media-app-guide.preview.emergentagent.com/api/healthz
GET  https://media-app-guide.preview.emergentagent.com/api/tribes
POST https://media-app-guide.preview.emergentagent.com/api/auth/register
```
