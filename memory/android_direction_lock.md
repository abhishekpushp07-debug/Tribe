...
### Base URL
```
https://tribe-docs-hub.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://tribe-docs-hub.preview.emergentagent.com/api/healthz
GET  https://tribe-docs-hub.preview.emergentagent.com/api/tribes
POST https://tribe-docs-hub.preview.emergentagent.com/api/auth/register
```
...
Base URL: `https://tribe-docs-hub.preview.emergentagent.com`
