...
### Base URL
```
https://tribe-pages.preview.emergentagent.com
```

All API endpoints are prefixed with `/api`. Example:
```
GET  https://tribe-pages.preview.emergentagent.com/api/healthz
GET  https://tribe-pages.preview.emergentagent.com/api/tribes
POST https://tribe-pages.preview.emergentagent.com/api/auth/register
```
