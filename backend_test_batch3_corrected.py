#!/usr/bin/env python3
"""
BATCH 3 CORRECTED: Stories (30 endpoints) + Reels (30 endpoints) 
Fixed validation issues and proper API contract usage
"""
...
def main():
    print("🚀 BATCH 3 CORRECTED: STORIES + REELS COMPREHENSIVE TEST")
    ...
    # ============================================================================
    # STORIES ENDPOINTS (25 endpoints + 5 dependent on IDs)
    # ============================================================================
    
    print("\n📖 STORIES TESTING (30 endpoints)")
    print("="*60)
    
    # 1. Create first story - Fixed: Use storyType TEXT correctly
    story_result = test_endpoint(
        "1. POST /api/stories", "POST", "/stories", token1,
        {"storyType":"TEXT","text":"Batch3 test story","backgroundColor":"#ff5722"},
        [200, 201]
    )
    ...
    story2_result = test_endpoint(
        ...
        {"storyType":"TEXT","text":"Test interactions","backgroundColor":"#2196f3"},
        [200, 201]
    )
    ...
    # 17. Create highlight - Use proper field names
    if story_id2:
    ...
    # Don't wait for SSE to complete, just check it starts successfully
    ...
    if reel_id:
        ...
        # 38. Report reel (token2) - Fixed: Use different user
        ...
        # 42. Watch reel (token2) - Fixed: Use correct field name
        ...
        # 44. Publish reel (token1, owner) - Use draft reel
        if draft_id:
    ...
    # Categorize results (approximate split - stories first ~30, then reels ~30)
    ...
    print("\n" + "="*80)
    print("📊 BATCH 3 CORRECTED: STORIES + REELS TEST REPORT")
    print("="*80)
    ...
    # Summary based on contract adherence
    contract_issues = []
    if stories_success_rate < 80:
        contract_issues.append("Stories API contract issues")
    if reels_success_rate < 80:
        contract_issues.append("Reels API contract issues")
