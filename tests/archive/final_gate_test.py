...
Base URL: https://tribe-docs-hub.preview.emergentagent.com/api
...
# Configuration
BASE_URL = "https://tribe-docs-hub.preview.emergentagent.com/api"
...
def run_all_5_gates():
    ...
    print("Base URL: https://tribe-docs-hub.preview.emergentagent.com/api")
