...
Base URL: https://media-trust-engine.preview.emergentagent.com/api
...
BASE_URL = os.getenv("NEXT_PUBLIC_BASE_URL", "https://media-trust-engine.preview.emergentagent.com") + "/api"
