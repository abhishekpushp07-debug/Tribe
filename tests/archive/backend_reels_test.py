...
Base URL: https://tribal-architecture.preview.emergentagent.com/api
...
BASE_URL = os.getenv("NEXT_PUBLIC_BASE_URL", "https://tribal-architecture.preview.emergentagent.com") + "/api"
