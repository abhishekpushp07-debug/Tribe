...
Base URL: https://comprehensive-guide-1.preview.emergentagent.com/api
...
BASE_URL = os.getenv("NEXT_PUBLIC_BASE_URL", "https://comprehensive-guide-1.preview.emergentagent.com") + "/api"
