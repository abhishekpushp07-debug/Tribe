...
Base URL: https://reel-video-upload.preview.emergentagent.com/api
...
BASE_URL = os.getenv("NEXT_PUBLIC_BASE_URL", "https://reel-video-upload.preview.emergentagent.com") + "/api"
