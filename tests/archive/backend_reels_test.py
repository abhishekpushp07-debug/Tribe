...
Base URL: https://gap-closure-phase-c.preview.emergentagent.com/api
...
BASE_URL = os.getenv("NEXT_PUBLIC_BASE_URL", "https://gap-closure-phase-c.preview.emergentagent.com") + "/api"
