...
// Allowed audience-selectable visibility values for content creation
export const CONTENT_ALLOWED_VISIBILITIES = ['PUBLIC', 'HOUSE_ONLY', 'COLLEGE_ONLY', 'FOLLOWERS']
...
export const NotificationType = {
  ...
  // B6-P4: Story notification types
