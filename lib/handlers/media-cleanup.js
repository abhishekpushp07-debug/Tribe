...
// Skips gracefully if video is too small or not a real video file
export async function generateVideoThumbnail(db, videoAsset) {
  ...
  try {
    ...
    if (videoBuffer.length < 10000) return null // Not a real video
    ...
    try {
      ...
      return null // ffmpeg didn't produce output — not a valid video
    }
