...
export async function handleContent(path, method, request, db) {
  ...
  if (route === 'content/posts' && method === 'POST') {
    ...
    invalidateOnEvent('POST_CREATED', { collegeId: contentItem.collegeId, houseId: contentItem.houseId, kind: contentKind })
  ...
  if (path[0] === 'content' && path.length === 2 && method === 'DELETE') {
    ...
    invalidateOnEvent('POST_DELETED', { collegeId: post.collegeId, houseId: post.houseId, kind: post.kind })
